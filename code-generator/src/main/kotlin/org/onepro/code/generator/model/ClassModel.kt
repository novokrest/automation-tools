package org.onepro.code.generator.model

import org.onepro.code.generator.writer.ClassUtils
import org.onepro.code.generator.writer.CodeWriter
...
data class AnnotationModel(
    ...
    companion object {
        val NONNULL = AnnotationModel(Nonnull::class, emptyList())
        val NULLABLE = AnnotationModel(Nullable::class, emptyList())
